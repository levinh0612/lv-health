...
export async function POST(req: NextRequest) {
  ...
  const [row] = await getDb()
    ...
    .values({
      ...
      obesityDegreePercent: body.obesityDegreePercent ?? null,
      weightControlKg: body.weightControlKg ?? null,
      bodyFatControlKg: body.bodyFatControlKg ?? null,
      muscleControlKg: body.muscleControlKg ?? null,
      abdominalFatRatio: body.abdominalFatRatio ?? null,
      medianaScore: body.medianaScore ?? null,
      totalEnergyExpenditureKcal: body.totalEnergyExpenditureKcal ?? null,
